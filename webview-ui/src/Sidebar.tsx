                    ...
                    <div style={{ padding: '16px', borderTop: '1px solid #222', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{
                            ...
                            <Markdown components={{
                                ...
                                h1: ({ node, ...props }) => <h1 style={{ fontSize: '14px', fontWeight: 'bold', marginTop: '12px', marginBottom: '8px', color: '#fff' }} {...props} />,
                                h2: ({ node, ...props }) => <h2 style={{ fontSize: '13px', fontWeight: 'bold', marginTop: '10px', marginBottom: '6px', color: '#eee' }} {...props} />,
                                h3: ({ node, ...props }) => <h3 style={{ fontSize: '12px', fontWeight: 'bold', marginTop: '8px', marginBottom: '4px', color: '#ddd' }} {...props} />,
                            }}>
                                {capsules.stats.projectOverview}
                            </Markdown>
                            {!isSummaryExpanded && (
